...
export interface ApiArticlePresseArticlePresse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    fichierPdf: Schema.Attribute.Media<'files'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::article-presse.article-presse'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titre: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['pdf', 'lien']> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    urlExterne: Schema.Attribute.String;
...
export interface ApiArtisteArtiste extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contexteArtistique: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::artiste.artiste'> &
      Schema.Attribute.Private;
...
export interface ApiExpositionExposition extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::exposition.exposition'> &
      Schema.Attribute.Private;
    ...
    statut: Schema.Attribute.Enumeration<['en-cours', 'passee']> &
      Schema.Attribute.DefaultTo<'en-cours'>;
    titre: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    visuels: Schema.Attribute.Media<'images', true>;
  };
}

export interface ApiMessageContactMessageContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    dateEnvoi: Schema.Attribute.DateTime;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::message-contact.message-contact'> &
      Schema.Attribute.Private;
    message: Schema.Attribute.Text & Schema.Attribute.Required;
    nom: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    referenceExposition: Schema.Attribute.String;
    referenceOeuvre: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiOeuvreOeuvre extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    artiste: Schema.Attribute.Relation<'manyToOne', 'api::artiste.artiste'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    dimensions: Schema.Attribute.String;
    expositions: Schema.Attribute.Relation<'manyToMany', 'api::exposition.exposition'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::oeuvre.oeuvre'> &
      Schema.Attribute.Private;
    provenance: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'titre'>;
    technique: Schema.Attribute.String;
    thematiques: Schema.Attribute.Relation<'manyToMany', 'api::thematique.thematique'>;
    titre: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    visuels: Schema.Attribute.Media<'images', true>;
...
export interface ApiThematiqueThematique extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::thematique.thematique'> &
      Schema.Attribute.Private;
    nom: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    oeuvres: Schema.Attribute.Relation<'manyToMany', 'api::oeuvre.oeuvre'>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'nom'>;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::article-presse.article-presse': ApiArticlePresseArticlePresse;
